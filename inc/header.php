        ...
        <div class="columns">
            <div class="column col-12 bar-top">
                <header class="navbar">
                    ...
                    <div class="navbar-section">
                        <a href="/donate.php" class="btn btn-sm btn-alternate d-inline">Donate</a>
                        <a href="<?php echo $siteFacebookURL; ?>" class="btn btn-link btn-action btn-sm d-inline"><svg class="svg-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-3 7h-1.924c-.615 0-1.076.252-1.076.889v1.111h3l-.238 3h-2.762v8h-3v-8h-2v-3h2v-1.923c0-2.022 1.064-3.077 3.461-3.077h2.539v3z"/></svg></a>
                        <button class="btn btn-link btn-action btn-sm show-md d-inline"><i class="icon icon-menu"></i></button>
                    </div>
                </header>
            </div>
